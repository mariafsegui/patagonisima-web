...
const PHOTO_URL = "/images/paisaje-patagonia.png"
...
export function VideoSection() {
  ...
  return (
    <section
      ...
      aria-label="Paisaje patagonico"
    >
      <Image
        src={PHOTO_URL}
        alt="Paisaje patagonico"
        fill
        sizes="100vw"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="flex items-center gap-6">
              ...
              <h3 className="text-xl md:text-3xl lg:text-4xl font-serif text-white tracking-tight drop-shadow-md">
                {t.video.title}{" "}
                <em className="italic text-white/90">{t.video.titleHighlight}</em>
              </h3>
              <span className="hidden md:block w-16 h-px bg-white/50" aria-hidden="true" />
            </div>
          </div>
